...
from etl_service.src.models.queries.sql_query_strings import per_sector_avg_quarterly_financials_query_str 
...
class MixinSectorQuarterlyFinancials:
    ...
    def to_avg_quarterly_financials_json_by_sector(self, sector_name, cursor):
        ...
        avg_quarterly_financial_objs = [self.build_avg_quarterly_financials_obj(record, cursor)
