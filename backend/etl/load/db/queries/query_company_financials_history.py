from backend.etl.load.db.queries.sql_query_strings import companies_within_sub_sector_str, company_quarterly_financials_query_str
from etl.transform.models.aggregate_analytics.aggregation_by_quarter import QuarterlyFinancials
