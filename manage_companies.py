...
from api.src.adapters.run_adapters import RequestAndBuildCompanies
import click
...
# prototyping 
company_runner = RequestAndBuildCompanies()
# pass in a sub_industry argument
company_runner.run('Railroads')
breakpoint()
"""
